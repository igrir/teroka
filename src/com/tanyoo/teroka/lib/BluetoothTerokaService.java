...
public class BluetoothTerokaService{
	private static final String TAG = "BluetoothTerokaService";
    private static final boolean D = true;

    // Name for the SDP record when creating server socket
    private static final String NAME_SECURE = "BluetoothTerokaSecure";
    private static final String NAME_INSECURE = "BluetoothTerokaInsecure";
 ...
 // Member fields
    ...
    //mengeset status bluetooth sesuai dengan index di connection state
    ...
    //mengubah menjadi mode server atau mendengarkan dari device lain
    ...
    //memulai status connect, atau mulai thread ConnectThread
   ...
   //eventhadler saat koneksi lost
    ...
    //menulis kepada conektedthread dalam kondisi tidak sinkron
    ...
    //memulai status terhubung atau konek, dan memulai thread Connectedthread
    ...
    //thread ini akan trus meneriima setiap koneksi yang masuk sampai ada koneksi yang diterima(saat mencari koneksi bluetooth)
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED) {
                ...
                if (socket != null) {
                    synchronized (BluetoothTerokaService.this) {
                        switch (mState) {
                        case STATE_LISTEN:
    ...
    //thread ini akan terus mengirimkan sinyal sampai ditangkap ooleh bluetooth lain
    ...
    //thread ini akan berlangsung saat kondisi bluetooth terkoneksii, ini akan menghandle transmisi data antar bluetooth
